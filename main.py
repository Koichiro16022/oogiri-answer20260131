...
if st.session_state.selected_odai:
    ...
    if st.button("回答20案生成", type="primary"):
        with st.spinner("魂の20案を捻り出し中..."):
            ...
            2. カッコ（）を使った補足や説明は一切不要。一言でオチをつけろ。
